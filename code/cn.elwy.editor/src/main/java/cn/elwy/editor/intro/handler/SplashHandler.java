package cn.elwy.editor.intro.handler;
...
public class SplashHandler extends AbstractSplashHandler {
    ...
    */}
    ...
    private void createUILabelPassword() {
        // Create the label
        Label lblp = new Label(fCompositeLogin, SWT.NONE);
        lblp.setText("密  码(&P)："); // NON-NLS-1
        // Configure layout data
        GridData gd_lblp = new GridData();
        gd_lblp.horizontalIndent = F_LABEL_HORIZONTAL_INDENT;
        lblp.setLayoutData(gd_lblp);
    }
    ...
    private void createUILabelUserName() {
        // Create the label
        Label lblu = new Label(fCompositeLogin, SWT.NONE);
        lblu.setText("用户名(&U)："); // NON-NLS-1
        // Configure layout data
        GridData gd_lblu = new GridData();
        gd_lblu.horizontalIndent = F_LABEL_HORIZONTAL_INDENT;
        lblu.setLayoutData(gd_lblu);
    }

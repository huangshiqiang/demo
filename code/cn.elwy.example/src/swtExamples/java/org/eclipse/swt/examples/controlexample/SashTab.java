...
class SashTab extends Tab {
    ...
    void layout() {
        ...
        list2.setBounds(vSashBounds.x + vSashBounds.width, 0, tabCompositeBounds.width
                - (vSashBounds.x + vSashBounds.width), hSashBounds.y);
        text.setBounds(0, hSashBounds.y + hSashBounds.height, tabCompositeBounds.width, tabCompositeBounds.height
    ...
    void shellResized() {
         ...
         */
        Rectangle list1Bounds = new Rectangle(0, 0, (tabFolderPageBounds.width - SASH_WIDTH) / 2,
                (tabFolderPageBounds.height - SASH_WIDTH) / 2);
         ...
         */
        list2.setBounds(list1Bounds.width + SASH_WIDTH, 0,
                tabFolderPageBounds.width - (list1Bounds.width + SASH_WIDTH), list1Bounds.height);
         ...
         */
        text.setBounds(0, list1Bounds.height + SASH_WIDTH, tabFolderPageBounds.width, tabFolderPageBounds.height
                - (list1Bounds.height + SASH_WIDTH));

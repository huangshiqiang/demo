...
/**
 * AddressBookExample is an example that uses <code>org.eclipse.swt</code> libraries to implement a simple address book.
...
public class AddressBook {
    ...
    private static final String[] columnNames = { resAddressBook.getString("Last_name"),
            ...
            resAddressBook.getString("Home_phone"), resAddressBook.getString("Email"), resAddressBook.getString("Fax") };

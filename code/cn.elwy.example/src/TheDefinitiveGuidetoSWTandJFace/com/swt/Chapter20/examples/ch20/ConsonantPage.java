package com.swt.Chapter20.examples.ch20;
...
public class ConsonantPage extends WizardPage {
    ...
    public ConsonantPage() {
        ...
        super("Consonant", "Consonant", ImageDescriptor.createFromFile(ConsonantPage.class, "/images/consonant.gif"));
    ...
    public void createControl(Composite parent) {
        ...
        text.addModifyListener(new ModifyListener() {
            public void modifyText(ModifyEvent event) {
                ...
                if (s.length() > 0
                        && (s.indexOf('A') != -1 || s.indexOf('E') != -1 || s.indexOf('I') != -1
    ...
    public void performHelp() {
        MessageDialog.openInformation(getWizard().getContainer().getShell(), "Consonant Help",
                "Enter consonants in the text box");
    }
}
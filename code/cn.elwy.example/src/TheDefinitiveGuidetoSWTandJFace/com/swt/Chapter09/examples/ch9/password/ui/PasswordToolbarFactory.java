package com.swt.Chapter09.examples.ch9.password.ui;
...
public class PasswordToolbarFactory {
    ...
    private static void createImages(Composite composite) {
        if (NEW == null) {
            ...
            SAVE_AS = new Image(display, c.getResourceAsStream(IMAGE_PATH + "saveAs.gif"));
            NEW_PASSWORD = new Image(display, c.getResourceAsStream(IMAGE_PATH + "password.gif"));
            EDIT_PASSWORD = new Image(display, c.getResourceAsStream(IMAGE_PATH + "editPassword.gif"));
            DELETE_PASSWORD = new Image(display, c.getResourceAsStream(IMAGE_PATH + "delPassword.gif"));
        }
    }
}

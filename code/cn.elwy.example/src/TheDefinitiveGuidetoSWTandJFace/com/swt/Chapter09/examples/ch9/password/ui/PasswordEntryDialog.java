...
public class PasswordEntryDialog extends Dialog {
    ...
    private void createContents(final Shell shell) {
        ...
        for (Iterator itr = Password.getApp().getMainWindow().getCurrentFile().getCategories().iterator(); itr
                .hasNext();) {
        ...
        ok.addSelectionListener(new SelectionAdapter() {
            public void widgetSelected(SelectionEvent event) {
                entry = new PasswordEntry(category.getText(), name.getText(), userId.getText(), password.getText());
                shell.close();
            }
        });

package com.swt.Chapter09.examples.ch9;
...
public class CLabelGradient {
    ...
    private void createContents(Composite parent) {
        ...
        one.setBackground(
                new Color[] { parent.getDisplay().getSystemColor(SWT.COLOR_RED),
        ...
        // Set the background gradient
        two.setBackground(
                new Color[] { parent.getDisplay().getSystemColor(SWT.COLOR_WHITE),

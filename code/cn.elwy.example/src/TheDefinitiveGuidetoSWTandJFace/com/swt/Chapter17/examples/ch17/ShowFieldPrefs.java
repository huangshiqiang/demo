package com.swt.Chapter17.examples.ch17;
...
public class ShowFieldPrefs {
    ...
    public void run() {
        ...
        // Create the nodes
        PreferenceNode one = new PreferenceNode("one", "One", null, FieldEditorPageOne.class.getName());
        PreferenceNode two = new PreferenceNode("two", "Two", null, FieldEditorPageTwo.class.getName());

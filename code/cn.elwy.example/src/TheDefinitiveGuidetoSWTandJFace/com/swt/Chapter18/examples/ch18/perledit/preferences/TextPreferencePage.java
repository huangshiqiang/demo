package com.swt.Chapter18.examples.ch18.perledit.preferences;
...
public class TextPreferencePage extends FieldEditorPreferencePage {
    ...
    protected void createFieldEditors() {
        ...
        fontFieldEditor = new FontFieldEditor(Constants.FONT, "Font:", "Font", getFieldEditorParent());
        addField(fontFieldEditor);

        // Add the field for word wrap
        wrapFieldEditor = new BooleanFieldEditor(Constants.WRAP, "Word Wrap", getFieldEditorParent());

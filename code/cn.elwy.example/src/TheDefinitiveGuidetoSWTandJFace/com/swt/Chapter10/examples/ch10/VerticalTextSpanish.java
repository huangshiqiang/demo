...
public class VerticalTextSpanish {
    ...
    public void run() {
        ...
        // Create "Hello" image
        final Image hello = GraphicsUtils.createRotatedText("Hola", font, shell.getForeground(), shell.getBackground(),
                SWT.UP);

        // Create "Good Bye" image
        final Image goodBye = GraphicsUtils.createRotatedText("Chao Pescado", font, shell.getForeground(),
                shell.getBackground(), SWT.DOWN);
        ...
        shell.addPaintListener(new PaintListener() {
            public void paintControl(PaintEvent event) {
                ...
                event.gc.drawImage(goodBye, rect.width - rcImage.width, rect.height - rcImage.height);
            }
        });

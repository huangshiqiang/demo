...
public class DrawImages {
    public void run() {
        ...
        // Load an image
        final Image image = new Image(display, this.getClass().getResourceAsStream("/images/swt.png"));
        ...
        shell.addPaintListener(new PaintListener() {
            public void paintControl(PaintEvent event) {
                ...
                // Draw the image
                event.gc.drawImage(image, srcX, srcY, srcWidth, srcHeight, rect.width - destWidth, rect.height

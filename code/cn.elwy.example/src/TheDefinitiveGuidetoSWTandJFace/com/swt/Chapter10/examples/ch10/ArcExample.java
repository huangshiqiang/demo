package com.swt.Chapter10.examples.ch10;
...
public class ArcExample {
    ...
    private class ArcExamplePaintListener implements PaintListener {
        public void paintControl(PaintEvent e) {
            ...
            try {
                width = txtWidth.getText().length() == 0 ? 0 : Integer.parseInt(txtWidth.getText());
                height = txtHeight.getText().length() == 0 ? 0 : Integer.parseInt(txtHeight.getText());
                begin = txtBeginAngle.getText().length() == 0 ? 0 : Integer.parseInt(txtBeginAngle.getText());
                angle = txtAngle.getText().length() == 0 ? 0 : Integer.parseInt(txtAngle.getText());
            ...
            e.gc.fillArc((x - width) / 2, (y - height) / 2, width, height, begin, angle);
        }
    }

package com.swt.Chapter11.examples.ch11;
...
public class PmpeLineStyleListener implements LineStyleListener {
    ...
    public void refreshMultilineComments(String text) {
        ...
        if (syntaxData != null) {
            ...
            for (int pos = text.indexOf(syntaxData.getMultiLineCommentStart()); pos > -1; pos = text.indexOf(
                    syntaxData.getMultiLineCommentStart(), pos)) {

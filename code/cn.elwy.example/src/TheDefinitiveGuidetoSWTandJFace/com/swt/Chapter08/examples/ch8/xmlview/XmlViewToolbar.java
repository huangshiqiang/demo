package com.swt.Chapter08.examples.ch8.xmlview;
...
public class XmlViewToolbar {
    ...
    private void createImages(Composite composite) {
        ...
        try {
            open = new Image(display, new FileInputStream(XmlView.IMAGE_PATH + "open.gif"));
            close = new Image(display, new FileInputStream(XmlView.IMAGE_PATH + "close.gif"));
            about = new Image(display, new FileInputStream(XmlView.IMAGE_PATH + "about.gif"));
        } catch (IOException e) {

...
public class XmlView {
    ...
    private static final String[] FILTER_NAMES = { "XML Files (*.xml)", "All Files (*.*)" };
    ...
    public Shell getShell() {
        if (shell == null) {
            throw new IllegalStateException("The main window has not yet been created");
        }
        return shell;
    }
    ...
    public void run() {
        ...
        try {
            ...
            icon = new Image(display, new FileInputStream(XmlView.IMAGE_PATH + "xmlview.gif"));
            shell.setImage(icon);
        } catch (IOException e) {

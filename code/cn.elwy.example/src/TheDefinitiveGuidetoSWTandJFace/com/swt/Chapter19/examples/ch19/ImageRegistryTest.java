...
public class ImageRegistryTest extends ApplicationWindow {
    ...
    protected Control createContents(Composite parent) {
        ...
        ir.put(ONE, ImageDescriptor.createFromFile(ImageRegistryTest.class, "/images/one.gif"));
        ir.put(TWO, ImageDescriptor.createFromFile(ImageRegistryTest.class, "/images/two.gif"));
        ir.put(THREE, ImageDescriptor.createFromFile(ImageRegistryTest.class, "/images/three.gif"));

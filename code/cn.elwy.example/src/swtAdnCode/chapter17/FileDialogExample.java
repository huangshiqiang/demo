...
//        s.setImage(new Image(d, "c:\\icons\\JavaCup.ico"));
        ...
        final MenuItem selectedItem = new MenuItem(filemenu, SWT.PUSH);
        selectedItem.setText("&selected\tCTRL+O");
        selectedItem.setAccelerator(SWT.CTRL + 'O');
        ...
        class Selected implements SelectionListener {
            public void widgetSelected(SelectionEvent event) {
                DirectoryDialog fd = new DirectoryDialog(s, SWT.SELECTED);
        ...
        selectedItem.addSelectionListener(new Selected());
